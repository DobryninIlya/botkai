...
async def info():
    try:
        ...
        await vk.messages.send(peer_id=MessageSettings.getPeer_id(),
                               message="Введите дату объявления, которое нужно удалить в формате дд.мм .Например, 15.08. Важно ввести именно в таком формате.",
                               keyboard=GetButtonDeleteByDate(),
