...
def info():
    ...
    vk.method("messages.send",
                {"peer_id": idUser, "message": "Файл #" + str(idMedia) + " одобрен и опубликован. Вам начислено 5 донат очков.", "random_id": random.randint(1, 2147483647)})
...
command.payload = "acceptstorage5"
