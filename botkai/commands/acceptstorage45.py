...
def info():
    ...
    vk.method("messages.send",
                {"peer_id": idUser, "message": "Файл #" + str(idMedia) + " одобрен и опубликован. Вам начислено 45 донат очков.", "random_id": random.randint(1, 2147483647)})
...
command.payload = "acceptstorage45"
