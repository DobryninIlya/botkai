    ...
    try:
        ...
        for elem in response:
            ...
            if (elem["dayDate"]).rstrip()=="чет" and ((datetime.date(today.year, today.month, today.day).isocalendar()[1] + chetn) % 2 == 0):
                ...
                tts += "stil <[1500]> {} {} {} stil <[500]>  в аудитории {} {} здание\n".format(
                ...
                tts += "stil <[1500]> первая подгруппа {} {} {} stil <[500]>  в аудитории {} {} здание\n".format(
                    elem["dayTime"], elem["disciplName"], typedict[(elem["disciplType"]).rstrip()], (elem["audNum"]).rstrip(), (elem["buildNum"]).rstrip())           
                ...
                tts += "stil <[1500]> вторая подгруппа {} {} {} stil <[500]>  в аудитории {} {} здание\n".format(
                    elem["dayTime"], elem["disciplName"], typedict[(elem["disciplType"]).rstrip()], (elem["audNum"]).rstrip(), (elem["buildNum"]).rstrip())
                ...
                tts += "stil <[1500]> {} {} {} в аудитории stil <[500]>  {} {} здание\n".format(
                    elem["dayTime"], elem["disciplName"], typedict[(elem["disciplType"]).rstrip()], (elem["audNum"]).rstrip(), (elem["buildNum"]).rstrip())
